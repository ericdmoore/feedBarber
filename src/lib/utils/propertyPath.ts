 ...
 */
export const getPath = (path:string | string[], input:JsonValue): JsonValue | undefined => {
...
export const setPath = (path:string | string[], replacerValue: JsonValue, input:JsonValue): JsonValue => {
    const pathSegments = typeof path === 'string' ? path.split('.') : path
