...
export type EasyLogEvent = { message: string; timestamp: number } | number | Date | string | Dict<unknown>;
...
export type StartQueryInput = StartQueryInputSingleGroupName | StartQueryInputMultiGroupName;
...
export type PromiseRequestFn = (req: Request | Promise<Request>) => Promise<Request>;
...
export class cloudwatchClient {
	...
	constructor(key: string, secret: string, region?: string, signer?: PromiseRequestFn, middlewareFns?: PromiseRequestFn[]) {
		this.#key = key;
		this.#secret = secret;
		this.region = region ?? 'us-central-1';
		this.signer = signer ?? sigMaker(this.#key, this.#secret, this.region, this.service);
	...
	cancelExportTask(i: CancelExportTaskInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.CancelExportTask', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	createExportTask(i: CreateExportTaskInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.CreateExportTask', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	createLogStream(i: CreateLogStreamInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.CreateLogStream', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	deleteDestination(i: DeleteDestinationInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteDestination', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	deleteLogStream(i: DeleteLogStreamInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteLogStream', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	deleteQueryDefinition(i: DeleteQueryDefinitionInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteQueryDefinition', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DeleteQueryDefinitionInput>(middleware(this.middlewareFns)(r));
	}
	deleteResourcePolicy(i: DeleteResourcePolicyInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteResourcePolicy', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	deleteRetentionPolicy(i: DeleteRetentionPolicyInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteRetentionPolicy', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DeleteRetentionPolicyInput>(middleware(this.middlewareFns)(r));
	}
	deleteSubscriptionFilter(i: DeleteSubscriptionFilterInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DeleteSubscriptionFilter', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DeleteSubscriptionFilterInput>(middleware(this.middlewareFns)(r));
	}
	describeDestinations(i: DescribeDestinationsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeDestinations', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	describeExportTasks(i: DescribeExportTasksInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeExportTasks', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	describeLogGroups(i: DescribeLogGroupsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeLogGroups', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	describeLogStreams(i: DescribeLogStreamsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeLogStreams', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	describeMetricFilters(i: DescribeMetricFiltersInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeMetricFilters', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DescribeMetricFiltersInput>(middleware(this.middlewareFns)(r));
	}
	describeQueries(i: DescribeQueriesInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeQueries', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	describeQueryDefinitions(i: DescribeQueryDefinitionsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeQueryDefinitions', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DescribeQueryDefinitionsInput>(middleware(this.middlewareFns)(r));
	}
	describeResourcePolicies(i: DescribeResourcePoliciesInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeResourcePolicies', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DescribeResourcePoliciesInput>(middleware(this.middlewareFns)(r));
	}
	describeSubscriptionFilters(i: DescribeSubscriptionFiltersInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DescribeSubscriptionFilters', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<DescribeSubscriptionFiltersInput>(middleware(this.middlewareFns)(r));
	}
	disassociateKmsKey(i: DisassociateKmsKeyInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.DisassociateKmsKey', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	getLogEvents(i: GetLogEventsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.GetLogEvents', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	getLogGroupFields(i: GetLogGroupFieldsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.GetLogGroupFields', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	getLogRecord(i: GetLogRecordInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.GetLogRecord', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	getQueryResults(i: GetQueryResultsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.GetQueryResults', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putDestination(i: PutDestinationInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutDestination', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putDestinationPolicy(i: PutDestinationPolicyInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutDestinationPolicy', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putLogEvents(i: PutLogEventsInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutLogEvents', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putMetricFilter(i: PutMetricFilterInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutMetricFilter', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putQueryDefinition(i: PutQueryDefinitionInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutQueryDefinition', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putResourcePolicy(i: PutResourcePolicyInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutResourcePolicy', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	putSubscriptionFilter(i: PutSubscriptionFilterInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.PutSubscriptionFilter', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
		return sendIt<PutSubscriptionFilterInput>(middleware(this.middlewareFns)(r));
	}
	...
	stopQuery(i: StopQueryOutput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.StopQuery', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	tagLogGroup(i: TagLogGroupInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.TagLogGroup', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	testMetricFilter(i: TestMetricFilterInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.TestMetricFilter', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
	...
	untagLogGroup(i: UntagLogGroupInput) {
		const r = new Request(this.baseURL, {
			method: 'POST',
			headers: { 'X-Amz-Target': 'Logs_20140328.UntagLogGroup', 'Content-Type': 'application/x-amz-json-1.1' },
			body: JSON.stringify(i),
		});
