...
!function () {
  ...
  function ot(t) {
    return t.size !== $.size || t.x !== $.x || t.y !== $.y ||
      t.rotate !== $.rotate || t.flipX || t.flipY;
  }
  function st() {
    var t,
      a,
    ...
    return "fa" === n && i === e ||
      (t = new RegExp("\\.".concat("fa", "\\-"), "g"),
        ...
        r = r.replace(t, ".".concat(n, "-")).replace(a, "--".concat(n, "-"))
          .replace(e, ".".concat(i))),
      r;
  }
  var ct = !1;
  ...
  function vt(t) {
    var e,
      ...
      n = t.children,
      n = void 0 === n ? [] : n;
    return "string" == typeof t ? it(t) : "<".concat(a, " ").concat(
      (e = i,
        Object.keys(e || {}).reduce(function (t, a) {
          return t + "".concat(a, '="').concat(it(e[a]), '" ');
        }, "").trim()),
      ">",
    ).concat(n.map(vt).join(""), "</").concat(a, ">");
  }
  function pt(t, a, e) {
  ...
  function wt(t, a, e) {
    ...
    "function" != typeof ut.hooks.addPack || e
      ...
      : ut.hooks.addPack(t, kt(a)), "fas" === t && wt("fa", a);
  }
  var xt = ut.styles,
    At = ut.shims,
  ...
  function Ht(t, a) {
    ...
    (t.includes(i[I]) || t.some(function (t) {
      ...
      (t.includes(i[L]) || t.some(function (t) {
    ...
    a = t.reduce(function (t, a) {
      ...
      return xt[a]
        ...
        : e
        ? t.iconName = e
        : a !== J.replacementClass && a !== i[I] && a !== i[L] &&
          t.rest.push(a),
  ...
  function Vt(t) {
    ...
    if (a) {
      return a = Yt(t, a) || a, pt(Gt.definitions, t, a) || pt(ut.styles, t, a);
    }
  }
  var Gt = new u(),
    Kt = {
    ...
    Jt = function () {
      var t =
          (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {})
            .autoReplaceSvgRoot,
        t = void 0 === t ? h : t;
      (0 < Object.keys(ut.styles).length || J.autoFetchSvg) && y &&
        J.autoReplaceSvg && Kt.dom.i2svg({ node: t });
    };
  function Qt(a, t) {
    return Object.defineProperty(a, "abstract", { get: t }),
    ...
    return t.children = e,
      ...
      s
        ...
        : (g = (p = t).children,
          ...
          h = p.attributes,
          t = p.styles,
          ot(p = p.transform) && y.found && !v.found &&
          (v = y.width / y.height / 2,
            y = .5,
            h.style = rt(
              k(k({}, t), {}, {
                "transform-origin": "".concat(v + p.x / 16, "em ").concat(
                  y + p.y / 16,
                  "em",
                ),
              }),
  ...
  function $t(t) {
    var a = t.content,
      ...
      s = t.watchable,
      c = void 0 !== s && s,
      t = k(k(k({}, o.attributes), r ? { title: r } : {}), {}, {
    ...
    ot(i) &&
      (s.transform =
        (o = (c = { transform: i, startCentered: !0, width: e, height: n })
          ...
          e = "",
          e += c && w
            ? "translate(".concat(o.x / Z - (void 0 === i ? x : i) / 2, "em, ")
              .concat(o.y / Z - n / 2, "em) ")
            : c
            ? "translate(calc(-50% + ".concat(o.x / Z, "em), calc(-50% + ")
              .concat(o.y / Z, "em)) ")
            : "translate(".concat(o.x / Z, "em, ").concat(o.y / Z, "em) "),
          e += "scale(".concat(o.size / Z * (o.flipX ? -1 : 1), ", ").concat(
            o.size / Z * (o.flipY ? -1 : 1),
            ") ",
          ),
    ...
    s = [];
    return s.push({ tag: "span", attributes: t, children: [a] }),
      r &&
      s.push({ tag: "span", attributes: { class: "sr-only" }, children: [r] }),
      s;
  }
  var ta = ut.styles;
  function aa(t) {
  ...
  function na(i, r) {
    var o = r;
    return "fa" === r && null !== J.styleDefault && (r = Nt),
      new Promise(function (t, a) {
        ...
        e = i,
          n = r,
          M || J.showMissingIcons || !e ||
          console.error(
            'Icon with name "'.concat(e, '" and prefix "').concat(
              n,
              '" is missing.',
            ),
          ),
  ...
  var oa = J.measurePerformance && d && d.mark && d.measure
      ? d
      : { mark: ia, measure: ia },
    sa = 'FA "6.2.0"',
    ca = {
  ...
  var da = {
    ...
    nest: function (t) {
      ...
      delete e[0].attributes.id,
        ...
        (t = e[0].attributes.class.split(" ").reduce(function (t, a) {
          return (a === J.replacementClass || a.match(n) ? t.toSvg : t.toNode)
            .push(a),
            t;
        }, { toNode: [], toSvg: [] }),
          ...
          pa || (i = Nt,
            et(t).forEach(function (t) {
              ...
              (J.searchPseudoElements && s(t.target), r(t.target)),
                ...
                J.searchPseudoElements && s(t.target.parentNode),
                "attributes" === t.type && la(t.target) &&
                ...
                ("class" === t.attributeName &&
                  ...
                  : (a = t.target) && a.classList && a.classList.contains &&
                    a.classList.contains(J.replacementClass) && o(t.target));
            }));
        }),
        y &&
        ya.observe(t, {
  ...
  function wa(t) {
    ...
    return i.prefix || (i.prefix = Nt),
      ...
      (i.prefix && 0 < n.length &&
        ...
        !i.iconName && J.autoFetchSvg && t.firstChild &&
  ...
  function xa(t, a) {
    var e = 1 < arguments.length && void 0 !== a ? a : { styleParser: !0 },
      ...
      s = (a = et((s = t).attributes).reduce(function (t, a) {
        return "class" !== t.name && "style" !== t.name &&
          (t[a.name] = a.value),
          t;
      }, {}),
        ...
        J.autoA11y && (n
          ? a["aria-labelledby"] = "".concat(J.replacementClass, "-title-")
            .concat(s || at())
  ...
  function Pa(t) {
    ...
    var o = [".".concat(_, ":not([").concat(O, "])")].concat(
      e.map(function (t) {
  ...
  function Sa(t) {
    ...
    if (t) {
      ...
      return Qt(k({ type: "icon" }, t), function () {
        return Bt("beforeDOMElementCreation", { iconDefinition: t, params: a }),
          J.autoA11y &&
          (s
            ? l["aria-labelledby"] = "".concat(J.replacementClass, "-title-")
              .concat(c || at())
            ...
            return Qt({ type: "layer" }, function () {
              ...
              return t(function (t) {
                ...
                [{
                  tag: "span",
                  attributes: {
                    class: ["".concat(J.cssPrefix, "-layers")].concat(l(n))
                      .join(" "),
                  },
                  children: a,
                }];
        ...
        return {
          counter: function (i) {
            ...
            return Qt({ type: "counter", content: i }, function () {
              return Bt("beforeDOMElementCreation", { content: i, params: r }),
                t = {
                  content: i.toString(),
                  title: o,
                  extra: {
                ...
                e = t.title,
                n = t.extra,
                t = k(k(k({}, n.attributes), e ? { title: e } : {}), {}, {
        ...
        return {
          text: function (t) {
            ...
            return Qt({ type: "text", content: t }, function () {
              return Bt("beforeDOMElementCreation", { content: t, params: a }),
                $t({
                  content: t,
                  transform: k(k({}, $), n),
                  title: i,
    ...
    return new Promise(function (e, t) {
      ...
      u && "none" !== d && "" !== d
        ? (s = l.getPropertyValue("content"),
          ...
          n = ~["Solid", "Regular", "Light", "Thin", "Duotone", "Brands", "Kit"]
              .indexOf(u[2])
            ? D[a][u[2].toLowerCase()]
            : X[a][m],
          d =
            (l =
              (l = (d = s).replace(ja, ""),
                a = 0,
                s = (m = l).length,
                c = 55296 <= (d = m.charCodeAt(a)) && d <= 56319 && a + 1 < s &&
                    56320 <= (c = m.charCodeAt(a + 1)) && c <= 57343
          ...
          (d = jt[l = d],
            l = Lt("fas", l),
            (l = d || (l ? { prefix: "fas", iconName: l } : null) ||
              { prefix: null, iconName: null }).iconName &&
            l.prefix && (u = l.iconName, n = l.prefix)),
  ...
  function Ia(t) {
    return !(t.parentNode === document.head ||
      ~z.indexOf(t.tagName.toUpperCase()) || t.getAttribute(N) ||
  ...
  Fa = { mixoutsTo: Kt }.mixoutsTo,
      ...
      provides: function (t) {
        t.generateAbstractTransformGrouping = function (t) {
          var a = t.main,
            ...
            n = "scale(".concat(e.size / 16 * (e.flipX ? -1 : 1), ", ").concat(
      ...
      provides: function (t) {
        t.generateAbstractMask = function (t) {
          var a = t.children,
            ...
            f = i.width,
            t = i.icon,
            o = (i = (n = { transform: o, containerWidth: f, iconWidth: s })
              .transform,
              o = n.containerWidth,
              f = n.iconWidth,
              s = { transform: "translate(".concat(o / 2, " 256)") },
              n = "translate(".concat(32 * i.x, ", ").concat(32 * i.y, ") "),
              o = "scale(".concat(i.size / 16 * (i.flipX ? -1 : 1), ", ")
            ...
            f = {
              ...
              children: [
                Da(
                  k(
                    { tag: c.tag, attributes: k(k({}, c.attributes), o.path) },
                    f,
                  ),
                ),
              ],
    ...
    c.forEach(function (t) {
      ...
      Object.keys(e).forEach(function (a) {
        "function" == typeof e[a] && (Fa[a] = e[a]),
          "object" === i(e[a]) && Object.keys(e[a]).forEach(function (t) {
    ...
    function (t) {
      ...
      p && (g.FontAwesome || (g.FontAwesome = Kt),
        bt(function () {
          Jt(), Bt("bootstrap");
        })),
