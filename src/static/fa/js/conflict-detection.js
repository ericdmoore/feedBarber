...
(function (global, factory) {
  ...
  function pollUntil(_ref) {
    var _ref$fn = _ref.fn,
      ...
      initialDuration = _ref$initialDuration === void 0
        ? 1
  ...
  function conflictDetection() {
    ...
    var testCount = Object.keys(scriptsToTest).length +
      Object.keys(cssToTest).length; // The resultsCollectionMaxWait allows for the time between when the tests running under
